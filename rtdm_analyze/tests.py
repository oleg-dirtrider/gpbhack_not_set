        ...
        Block(id='HECG1MAA03G5SPP2', name='GET_CLIENT',
              ...
              subdiagram_name=None)],
                 'campaigns': [
                     ...
                     Campaign(id='CGAE43ALKBEQVDMS', name='HACK1_DOC_CHECKS')],
                 'data_processes': [DataProcess(id='CHHBBPOBK3EBT45Y',
                                    ...
                                    DataProcess(id='BDDAORJDAFGOUFMB',
                                                name='READ_INCOME',
                                                lib_name='HACK1_INT',
                                                table_name='INCOME', columns=[
                                            {'name': 'RUN_ID',
                                             'type_description': 'double'}]),
                                    DataProcess(id='CHFGITJOYFEXX2HV',
                                                name='INS_CHECK',
                                                lib_name='HACK1_MAIN',
                                                table_name='CHECKS', columns=[
                                            {'name': 'RUN_ID',
                                             'type_description': 'double'},
                                            {'name': 'APP_ID',
                                             'type_description': 'double'},
